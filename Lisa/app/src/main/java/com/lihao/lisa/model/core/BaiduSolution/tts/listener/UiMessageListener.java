package com.lihao.lisa.model.core.baidu.tts.listener;
...
public class UiMessageListener extends MessageListener {
    ...
    public void onSpeechProgressChanged(String utteranceId, int progress) {
        ...
        Log.d(TAG, "onSpeechProgressChanged: progress: " + progress);
        mProgress = progress;
        TTSMessage ttsMsg = new TTSMessage(RESULT_SUCCESS, TTS_STATUS_INPUT_TEXT_SELECTION);
        ttsMsg.setmProgress(progress);
